...
const projects = [
  ...
  },
  {
    ...
    modelFile: ['/models/FolkNEW.glb', '/models/Traktors.glb'],
  },
  {
    id: 'LATA',
    ...
    learnedLV: 'Attīstīt, pilnveidot un realizēt idejas, kā arī galvenokārt uzlabot prasmes prezentēt un pārliecinoši uzstāties par tehniskiem risinājumiem.',
    learnedEN: 'Develop, refine and implement ideas, as well as, above all, improve your skills in presenting and convincingly speaking about technical solutions.',
